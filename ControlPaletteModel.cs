...
namespace Files_Theme_Importer_Tool
{
    ...
    {
        Task InitializeData(string dataPath);
    ...
    {
        public async Task InitializeData(string dataPath)
        {
            ...
            _whiteColor = new ColorPaletteEntry(Colors.White, "DarkThemeTextContrastTitle", null, ColorStringFormat.PoundRGB, null);
            _blackColor = new ColorPaletteEntry(Colors.Black, "LightThemeTextContrastTitle", null, ColorStringFormat.PoundRGB, null);
        ...
        private string GenerateMappingDescription(IColorPaletteEntry paletteEntry, List<ColorMapping> mappings)
        {
            ...
            if (retVal != string.Empty)
            {
                return string.Format("ColorFlyoutMappingDescription", retVal);
            }
            else
            {
                return null;
        ...
        private ObservableList<Preset> _presets = new ObservableList<Preset>();
